...
const footer = document.getElementById("apr-footer");

generatePdfButton.addEventListener("click", () => gerarPDF());
...
const gerarPDF = () => {
  ...
  const isContrastActive = getIsContrastActive();
  if (isContrastActive) toggleContrast();
